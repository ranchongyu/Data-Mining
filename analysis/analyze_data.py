...
# flags.DEFINE_string("data", "../data/split_encoded_train",
#                     "Directory containing full dataset.")
flags.DEFINE_string("data", "../data/split_encoded_train/mapped_goemotions_1.csv", "Path to mapped CSV.")


flags.DEFINE_string("plot_dir", "../results/figure",
...
def main(_):
    ...
    for col in all_emotions_neutral:
